...
#' @param Omega \emph{Optional} positive definite correlation matrix of size \code{M x M}.
#' If not provided, it is generated using an LKJ prior with shape parameter 1.
